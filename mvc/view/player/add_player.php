<?php
    ...
    $teams = array("Panthers","Bulls","Phoenix", "Falcons",
);
...
<!-- <option value=<?php echo $page_id ?>><?php echo $teams[$page_id]; ?></option> -->
     ...
     <div class="form-group">
       ...
       <option value=1>BUDC Panthers</option>
        <option value=2>ROBU Bulls</option>
        <option value=3>CHESS Phoenix</option>
        <option value=4>BUFC Falcons</option>
