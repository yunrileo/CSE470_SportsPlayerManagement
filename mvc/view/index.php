...
<br>
    ...
    <div class="col-lg-8">
        <h1 class="heading">BRACU Sports: "Team beating with the same heart"</h1>
        <p id="p"> Sports Program at BRAC University is designed to serve student interest in different sports and recreational
            activities.
            These
            interests can be competitive, recreational or instructional in nature; students may represent the University
            in
            inter-university competition or intra-club (BUFL) league activities such as tournament play, training,
            instruction, and
            social interaction (recreational) events.</p>

        <p id="p">BRAC University desires to extend sporting and recreational events to any
            ...
            the
            opportunity to participate individually or in mass with a team in the sports program at BRACU.</p>
    </div>
    <div class="col-lg-2">
    </div>
    </div>
                ...
                <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item" data-interval="2000">
                            <img src="assets/images/bracufl.jpg" class="d-block w-100" alt="...">
                        </div>
    ...
    <div class="col-lg-12">
        <div class="row">
            ...
            <div class="col-lg-10">
                <h1 class="teams">MEET the teams of BRACU: </h1>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-8">
        <div class="container-fuild flexing" style="width: auto;">
            <a href="team_page.php?id=1"><img src="assets/images/panthers-logo.jpeg" class="img"></a>
            <a href="team_page.php?id=2"><img src="assets/images/bulls-logo.jpeg" class="img"></a>
